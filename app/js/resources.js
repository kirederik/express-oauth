...
var inbuResources = angular.module("inbu.resources", ['ngResource']);

inbuResources.value('BASE_URL', "http://localhost:9898");
inbuResources.value('VERSION_URL', "");
inbuResources.value('HOST_BASE', "");

inbuResources.factory('Constants', ['BASE_URL', 'VERSION_URL', 'HOST_BASE', '$resource'
...
inbuResources.factory('Rest', ['Constants', '$resource', function(C, $resource) {
    return {
